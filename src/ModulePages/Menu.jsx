...
const Menu = ({
  ...
  const [Message, SetMessage] = useState(
    "Apakah Anda ingin Menambahkan Kedalam Playlist?"
  );
    ...
    <>
        ...
        <div ref={ContainerNavbar} className="ContainerNavBar">
          <div
            style={{
              ...
              display: "flex",
              alignItems: "center",
              justifyContent: !openNav ? "center" : "start",
            }}
          >
            <button
              style={{
                backgroundColor: "transparent",
                backgroundImage: 'url("/Images/icons8-back-arrow-50.png")',
                display: "flex",
          ...
          <div className="NavBar">
            ...
            >
              {openNav ? (
                ...
                <img
                  src="/Images/icons8-fast-forward-50.png"
                  width="40"
                  alt=""
                />
              )}
            ...
            {text.map((item) => (
                    ...
                    : () => {
                        if (item.name === "Add My Module") {
                          if (Location.includes("MyPlaylistModule")) {
                            ...
                            setTurnOnpOpup(true);
                            SetMessage(
                              "Anda Tidak Sedang Berada Dalam Room Module"
                            );
                          } else {
                            setisCallPopup(true);
                            setTurnOnpOpup(true);
              ...
              >
                {openNav ? item.name : <img src={item.pathImage} alt="" />}
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="MobileNavBar">
        ...
        >
          ...
          <span className="NavLabel">Add Playlist</span>
        </button>
        <button
          onClick={() => {
            navigate(`/MyPlaylistModule/${user}`);
        ...
        >
          <i className="fas fa-book"></i>
          <span className="NavLabel">My Modules</span>
        </button>
      </div>
      {isCallPopup ? (
        <Popup
