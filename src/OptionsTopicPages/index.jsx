                ...
                <div className="container">
                    ...
                    {isMobile ? (
                        ...
                        <div className="desktop-menu">
                            ...
                            <button onClick={() => navigate(`/MyPlaylistModule/${account.username}`)}>Lessons</button>
                            {isAuthor && <button onClick={() => navigate(`/ModulePages/${account.username}`)}>My Module</button>}
